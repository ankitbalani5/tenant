...
class RequestedPgDetails extends StatefulWidget {
  final PGProperty data;
  const RequestedPgDetails({Key? key, required this.data});

  @override
  State<RequestedPgDetails> createState() => _RequestedPgDetailsState();
}

class _RequestedPgDetailsState extends State<RequestedPgDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return
      Scaffold(
          ...
          //       decoration: BoxDecoration(
          //         borderRadius: BorderRadius.circular(20),
          //         border: Border.all(color: Constant.bgLight),
          //         color: /*widget.data.interested == 0 ? Constant.bgButton : */Colors.white,
          //       ),
          //       child: const Center(child: Text('Chat', style: TextStyle(color: Constant.bgLight, fontSize: 18, fontFamily: 'Poppins'),)),
          //     ),
          //   ),
          // ),
          bottomNavigationBar: Container(
            ...
            child: Padding(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => ChatScreen(
                      widget.data.branchName.toString(), widget.data.propertyImage![0].imagePath.toString(),
                      widget.data.branchId.toString(), widget.data.contactNumber.toString())));
                },
                child: BottomAppBar(
                  height: 50,
                      ...
                      Expanded(
                        child: Container(
                          decoration: BoxDecoration(
                            ...
                            color: /*widget.data.interested == 0 ? Constant.bgButton : */Constant.bgButton,
                          ),
                          child: const Center(child: Text('Chat', style: TextStyle(color: Colors.white, fontSize: 18, fontFamily: 'Poppins'),)),                        ),
                      )
                    ],
                  ),
                ),
